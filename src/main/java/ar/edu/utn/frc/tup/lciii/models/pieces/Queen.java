...
public class Queen extends Piece {
    ...
    public boolean movementValid(PiecePosition newPosition, List<Piece> piecesListOnBoard) {
        ...
        if (newPosition.getRow().equals(this.position.getRow())) {
            movementValid = checkObstacle(newPosition, piecesListOnBoard);
        } else if (newPosition.getColumn().equals(this.position.getColumn())) {
            movementValid = checkObstacle(newPosition, piecesListOnBoard);
        } else if (Math.abs(newPosition.getColumn() - this.position.getColumn())==
